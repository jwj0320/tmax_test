...
static struct esql_sqlctx {
    ...
    void                *hostvar[3];        /* array of host var */
    unsigned int         hostvar_len[3];    /* array of length of host var */
    unsigned int         hostvar_stride[3]; /* array of stride of host var */
    esql_hostvar_type_t  hostvar_type[3];   /* array of host var type */
    unsigned int         param_type[3];     /* array of param type */
    esql_desc_item_t     ansi_dyn_type[3];  /* array of ansi dyn item type */
    void                *hostind[3];        /* array of host ind */
    unsigned int         hostind_stride[3]; /* array of stride of host ind */
    long                 ind[3];            /* array of indicator */
...
struct __tag20 { unsigned short len; unsigned char arr[20]; } userpass = {strlen(USERPASS), USERPASS};
...
/*	        VARCHAR userpass[20] = {strlen(USERPASS), USERPASS};	*/
struct __tag21 { unsigned short len; unsigned char arr[20]; } userpass = {strlen(USERPASS), USERPASS};
 
/*	        VARCHAR id[50];	*/
struct __tag22 { unsigned short len; unsigned char arr[50]; } id;
 
/*	        VARCHAR name[50];	*/
struct __tag23 { unsigned short len; unsigned char arr[50]; } name;

/*	        VARCHAR dept[50];	*/
struct __tag24 { unsigned short len; unsigned char arr[50]; } dept;
	 ...
	 */
{
    ...
    __sqlctx.host_var_out_cnt   = 0;
    __sqlctx.hostvar[0]         = (void *)(id.arr);
    __sqlctx.hostvar_len[0]     = (unsigned int)50;
    __sqlctx.hostvar_stride[0]  = (unsigned int)0;
    __sqlctx.hostvar_type[0]    = ESQL_TYPE_UCHAR_ARRAY;
    __sqlctx.param_type[0]      = 0;
    __sqlctx.ansi_dyn_type[0]   = ESQL_DESC_ITEM_NONE;
    __sqlctx.hostind[0]         = (void *)0;
    __sqlctx.hostind_stride[0]  = (unsigned int)0;
    __sqlctx.hostvar[1]         = (void *)(name.arr);
    __sqlctx.hostvar_len[1]     = (unsigned int)50;
    __sqlctx.hostvar_stride[1]  = (unsigned int)0;
    __sqlctx.hostvar_type[1]    = ESQL_TYPE_UCHAR_ARRAY;
    ...
    __sqlctx.hostvar[2]         = (void *)(dept.arr);
    __sqlctx.hostvar_len[2]     = (unsigned int)50;
    __sqlctx.hostvar_stride[2]  = (unsigned int)0;
    __sqlctx.hostvar_type[2]    = ESQL_TYPE_UCHAR_ARRAY;
